...
#define EZ_PDB_BASE_OF_DLL (DWORD64)0x10000000
        ...
        std::string Download(std::string pePath, bool bRedownload = false)
        {
    ...
    public:
        ...
        int GetAttributeOffset(std::string StructName, std::wstring PropertyName)
        {
